...
if __name__ == '__main__':
	...
	#input_path = '../build/26_NN_dictionaries'
	#output_path = '../build/27_merged_dictionaries'
	...
	lemmas_dict_title = 'dense_lemmas_dictionary'
	...
	with open(os.path.join(output_path, 'inference_dictionaries.json'), 'w') as f:
